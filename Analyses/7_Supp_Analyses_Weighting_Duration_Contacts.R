...
unw_dur_overall$income <- factor(unw_dur_overall$income, levels = c("LIC", "UMIC", "HIC"))
...
wi_dur_overall <- wi_dur_overall %>%
  pivot_longer(cols = c("X5.", "mean", "X95."))
wi_dur_overall$income <- factor(wi_dur_overall$income, levels = c("LIC", "UMIC", "HIC"))
