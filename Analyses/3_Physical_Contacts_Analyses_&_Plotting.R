...
forestplot(combined, graph.pos = 2,
           mean  = cbind(physical_LIC_LMIC$forest_data_to_plot[, 1], physical_UMIC$forest_data_to_plot[, 1], physical_HIC$forest_data_to_plot[, 1]),
           lower = cbind(physical_LIC_LMIC$forest_data_to_plot[, 2], physical_UMIC$forest_data_to_plot[, 2], physical_HIC$forest_data_to_plot[, 2]),
           upper = cbind(physical_LIC_LMIC$forest_data_to_plot[, 3], physical_UMIC$forest_data_to_plot[, 3], physical_HIC$forest_data_to_plot[, 3]), 
