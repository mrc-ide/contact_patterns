...
hh <- readRDS(file = paste0("Outputs/", models, files[pmatch(paste0(metric, "_", income_strata, "_hh_size"), files)]))
age <- readRDS(file = paste0("Outputs/", models, files[pmatch(paste0(metric, "_", income_strata, "_age3cat"), files)]))
gender <- readRDS(file = paste0("Outputs/", models, files[pmatch(paste0(metric, "_", income_strata, "_gender"), files)]))
student <- readRDS(file = paste0("Outputs/", models, files[pmatch(paste0(metric, "_", income_strata, "_student"), files)]))
method <- readRDS(file = paste0("Outputs/", models, files[pmatch(paste0(metric, "_", income_strata, "_method"), files)]))
weekday <- readRDS(file = paste0("Outputs/", models, files[pmatch(paste0(metric, "_", income_strata, "_weekday"), files)]))
employment <- readRDS(file = paste0("Outputs/", models, files[pmatch(paste0(metric, "_", income_strata, "_employment"), files)]))
