...
age_emp <- empirical_summaries(data, "age3cat", "tot_all", income_strata)
gender_emp <- empirical_summaries(data, "part_gender", "tot_all", income_strata)
weekday_emp <- empirical_summaries(data, "weekday", "tot_all", income_strata)
hh_emp <- empirical_summaries(data, "hh_size", "tot_all", income_strata)
method_emp <- empirical_summaries(data, "method", "tot_all", income_strata)
student_emp <- empirical_summaries(data, "student", "tot_all", income_strata)
employment_emp <- empirical_summaries(data, "employment", "tot_all", income_strata)
