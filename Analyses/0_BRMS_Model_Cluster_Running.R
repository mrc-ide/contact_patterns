...
# MCMC Parameters
MCMC_parameters <- list(iterations = 7500, burnin = 3000, chains = 2, cores = 2)
...
physical_LIC_age$status()
physical_LIC_gender$status()
physical_LIC_weekday$status()
physical_LIC_hhsize$status()
physical_LIC_student$status()
physical_LIC_employment$status()
physical_LIC_method$status()
