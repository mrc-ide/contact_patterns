...
# PHYSICAL HIC NOW WORKING FOR SOME REASON - ASK ANDRIA. AND ADDITIONALLY, CHANGE THE CODE FOR IT
# IN brms_output_summary_function.R 
...
context_name <- paste0("N:/contact_matrix_work/new_context_", Sys.Date())
...
#######################################################################################
#                                                                                     #
#    Analysis 2: Total Contacts (With Additional Work/Group/Other Contacts)           #
#                                                                                     #
#######################################################################################
